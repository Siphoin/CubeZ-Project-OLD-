...
namespace CBZ.API
{
    ...
    public class APIObjectCube : APIObject, IAPIObjectMesh, IAPIObject
    {
        ...
        public void SetColorMaterial(Color32 color, int index = 0)
        {
            ...
            {
                Debug.Debug.Print($"index material greater then count materials on the object {name}", Debug.LogMessageType.Warning);
                return;
            }
